...
| --- | --- | --- | --- |
| *C-11* | *Customer Data Source Credentials* | *DEV* | *IP/URL: 192.1.1.1*<br>*Account name: serviceDYN-DEV@abc.ca*<br>*Password: [see IT department]* |
| *C-12* | *Customer Data Source Credentials* | *TEST* | *IP/URL: dynamics-TEST.abc.com*<br>*Account name: serviceDYN-TEST@abc.ca*<br>*Password: [see IT department]* |
| *C-13* | *Customer Data Source Credentials* | *PROD* | *IP/URL: dynamics.abc.com*<br>*Account name: serviceDYN@abc.ca*<br>*Password: [see IT department]* |
| *C-21* | *Invoice Data Source Credentials* | *DEV* | *IP/URL: 192.2.2.2*<br>*Account name: serviceSAP-DEV@abc.ca*<br>*Password: [see IT department]* |
| *C-22* | *Invoice Data Source Credentials* | *TEST* | *IP/URL: sap-TEST.abc.com*<br>*Account name: serviceSAP-TEST@abc.ca*<br>*Password: [see IT department]* |
| *C-23* | *Invoice Data Source Credentials* | *PROD* | *IP/URL: sap.abc.com*<br>*Account name: serviceSAP@abc.ca*<br>*Password: [see IT department]* |
