...
``` json
{
  ...
  "title": {
    ...
    "subtitle": {
      "expr": "'Toronto Stock Exchange (TSX) Composite Index Close' + '[::]' + 'For period = ' + timeFormat( data('data_0')[0]['_start_date'], '%d-%b-%Y' ) + ' to ' + timeFormat( data('data_0')[0]['_end_date'], '%d-%b-%Y' )"
    },
    "subtitlePadding": 2
  },
  // Power BI dataset
